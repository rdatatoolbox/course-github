...
- 45 millions d'utilisateur·trice·s en 2020
...
.center[
[![:scale 70.0%](img/github-pageprojet.png)](https://github.com/sdray/ade4)
]

- Arboresence du projet Git
- Page d'accueil README.md
- Liens et des informations globales
...
.center[
![:scale 50.0%](img/github-fork.png)
]
...
- Possibilité de suivre des personnes (Follow) et des projets (Watch, Star)
- Possibilité de créer un ![:scale 10.0%](img/github-wiki.png) ou une page web liée à votre projet
- Possibilité de bénéficier ou de proposer de l'aide sur des codes publics (![:scale 15.0%](img/github-issues.png))
- Possibilité de commenter des commits
- Grande visibilité
...
.pull-leftt[
![:scale 100%](img/github-actions2.png)
&nbsp;
![:scale 100%](img/github-actions.png)
]
.pull-rightt[
- Création d'un workflow dans l'onglet ![:scale 12%](img/github-workflow.png)
...
- Existe depuis 2011
- Entièrement open source (contrairement à GitHub)
- Possibilité d'avoir une installation GitLab auto-hébergée sur un serveur privé (voir [instance](https://doc.cc.in2p3.fr/fr/Collaborative-tools/tools/gitlab.html) académique disponible au centre de calcul de l'IN2P3 ; chez GitHub, uniquement accessible avec un plan d'entreprise payant)
